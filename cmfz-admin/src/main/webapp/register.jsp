...
<head>
	...
	<script type="text/javascript">
        $(function(){
            $(":input[name='mgrName']").blur(function(){
                $.ajax({
                    type:"POST",
                    url:"${pageContext.request.contextPath }/manager/checkMgrName",
                    data:"mgrName="+$(this).val(),
...
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath }/manager/register" method="post">
				<table>
					<tbody>
						<tr>
